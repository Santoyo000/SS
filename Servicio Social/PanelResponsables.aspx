<%@ Page Title="" Language="C#" MasterPageFile="~/SS.Master" AutoEventWireup="true" CodeBehind="PanelResponsables.aspx.cs" Inherits="Servicio_Social.PanelResponsables" %>
            ...
            <div class="container-fluid py-5">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-primary-custom" onclick="location.href='#'">
                            <div class="card-body">
                                ...
                                <p class="card-hover-text text-center justify-content-center">Información del Responsable de Unidad</p>
                            </div>
                        </div>
                    </div>
                    <!--Segunda tarjeta-->
                    <div class="col-md-4">
                        <div class="card bg-success-custom" onclick="location.href='DependenciasRegistradas.aspx'">
                            <div class="card-body">
                                <i class="fas fa-check-circle card-icon"></i>
                                <h5 class="card-title">Validar Dependencias</h5>
                                <p class="card-hover-text text-center justify-content-center">Permite validar Dependencias Registradas</p>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="col-md-4">
                   ...
                   <!-- Alumnos Registrados -->
                 <div class="col-md-4">
                     <div class="card bg-danger-custom" style="background-color: #229086;" onclick="location.href='AlumnosRegistrados.aspx'"> 
                         <div class="card-body">
                    ...
                    <!--Tercera tarjeta-->
                    <div class="col-md-4">
                        <div class="card bg-danger-custom" onclick="location.href='RegistroEncargadoEscuela.aspx'">
                            <div class="card-body">
                                <i class="fas fa-user-plus card-icon"></i>
                                <h5 class="card-title">Crear Usuario Encargado de Escuela</h5>
                                <p class="card-hover-text text-center justify-content-center">Permite crear usuario Encargado de Escuela</p>
                            </div>
                        </div>
                    </div>
                     <!-- Alumnos Registrados a Programas-->
                    <div class="col-md-4">
                        <div class="card bg-danger-custom" style="background-color: #78288C;" onclick="location.href='AlumnosPostulados.aspx'"> <%--AlumnosRegistrados.aspx--%>
                            <div class="card-body">
                                <i class="fas fa-users card-icon"></i>
                                <h5 class="card-title">Alumnos Asignados en Programas</h5>
                                <p class="card-hover-text text-center justify-content-center">Alumnos inscritos a Programas</p>
                            </div>
                        </div>
                    </div>
                    <%-- <div class="col-md-4">
                        <div class="card bg-warning-custom" onclick="location.href='ProgramasDependencias.aspx'">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Programas Registrados</h5>
                                <p class="card-hover-text text-center justify-content-center">Permite ver los Programas que ha sidos registrados por el usuario</p>
                            </div>
                        </div>
                    </div>--%>
                    <!--Cuarta tarjeta-->
                    <%--<div class="col-md-4">
                        <div class="card bg-danger-custom" onclick="location.href='#'">
                            <div class="card-body">
                                <i class="fas fa-users card-icon"></i>
                                <h5 class="card-title">Alumnos Registrados</h5>
                                <p class="card-hover-text text-center justify-content-center">Permite ver los Alumnos registrados a los programas (Actualmente en desarrollo)</p>
                            </div>
                        </div>
                    </div>--%>
                </div>
