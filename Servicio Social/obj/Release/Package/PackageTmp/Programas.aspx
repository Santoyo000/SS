<%@ Page Title="" Language="C#" MasterPageFile="~/SS.Master" AutoEventWireup="true" CodeBehind="Programas.aspx.cs" Inherits="Servicio_Social.Programas1" %>
   ...
   <%-- <asp:Panel ID="pnlCerrado" runat="server" Visible="false">
    <div style="text-align: center">
        <div class="form-group">
            ...
            <a href="PanelDependencia.aspx" cssclass="btn btn-primary">Volver a la página principal</a>
        </div>
    </div>
    </asp:Panel>
     --%>
    <asp:Panel ID="PANELPRINCIPAL" runat="server" Visible="true">
        <div style="text-align: center">
            <div class="form-group">
                <br />
                <h2 class="text-gray-900 mb-4" style="color: #2e5790">Registrar Programa</h2>
            </div>
        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="DDLUnidad" runat="server" CssClass="DropDownList-estilo"   AutoPostBack="true" OnSelectedIndexChanged="Unidad_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </td>
            </tr>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="DDLNIVEL1" runat="server" CssClass="DropDownList-estilo" OnSelectedIndexChanged="DDLPlan_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <asp:Panel ID="PNLPLAN" runat="server" Visible="false">
                        <td>
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="DDLPLAN1" runat="server" CssClass="DropDownList-estilo" DataTextField="Descripcion" DataValueField="idPlanEstudio" OnSelectedIndexChanged="DDLEscuela_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="DDLESC1" runat="server" CssClass="DropDownList-estilo" onchange="updateTitle(this)" DataTextField="Descripcion" DataValueField="IdEscuela" EnableViewState="true">
                                </asp:DropDownList>
                            </div>
                            <script>
                    ...
                    <td>
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" CssClass="gridview-estilo" OnRowDataBound="GridView2_RowDataBound" OnRowCommand="GridView2_RowCommand" ClientIDMode="Static">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Plan" HeaderText="Plan de Estudios" />
                                <asp:BoundField DataField="kpPlan" HeaderText="Plan de Estudios" />
                                ...
                                <asp:TemplateField HeaderText="Eliminar">
                                    <ItemTemplate>
                                        <asp:Button ID="btnBorrar" runat="server" CssClass="miBoton2" CommandName="EliminarRegistro" CommandArgument='<%# Container.DataItemIndex %>' Text="Eliminar" OnClientClick="return confirm('¿Eliminar registro?');" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col text-center">
                <asp:Button runat="server" ID="btnGuardar" CssClass="miBoton" Text="Guardar Programa" OnClick="btnGuardad_Click" />
            </div>
        </div>
    </asp:Panel>
