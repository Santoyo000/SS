<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="LoginResponsableUnidad.aspx.cs" Inherits="Servicio_Social.LoginResponsableUnidad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="titulo" runat="server">
     ...
     <asp:Panel runat="server" ID="pnlLogin" Visible="true">
         <div class="container login-container">
             ...
             <h2 class="login-title">Iniciar sesión: Responsable Unidad</h2>
