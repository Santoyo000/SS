<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="LoginEncargadoEscuela.aspx.cs" Inherits="Servicio_Social.LoginEncargadoEscuela" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="titulo" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlLogin" Visible="true">
        <div class="container login-container">
            ...
            <h2 class="login-title">Iniciar sesión: Encargado Escuela</h2>
